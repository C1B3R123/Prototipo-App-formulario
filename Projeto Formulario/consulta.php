<?php
$conn = new mysqli("localhost", "root", "", "gestao_alunos"); // Conexão com o banco de dados 'gestao_alunos' 

$search = $_GET['search'] ?? ''; // Obtém o termo de busca da URL
// Ajusta a query para buscar por nome, RA, email ou curso
$query = "SELECT * FROM alunos WHERE nome LIKE '%$search%' OR ra LIKE '%$search%' OR email LIKE '%$search%' OR curso LIKE '%$search%'"; // Consulta para buscar alunos 
